...
app.put('/api/contacts/:contactId', async (req, res) =>{
    ...
    const contactId = req.params.contactId
    const updatedContact = { id: req.body.id, name: req.body.name, email: req.body.email, phone: req.body.phone, address: req.body.address, birthday: req.body.birthday}
    ...
    const values = [updatedContact.name, updatedContact.email, updatedContact.phone, updatedContact.address, updatedContact.birthday];
    try {
